                  ...
                  <div class="dropdown">
                   <a  href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-database"></i> Data </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="kehadiran_2.php"><i class="fa fa-table"></i> Presensi </a>
                      <a class="dropdown-item" href="aksesperorang.php?Template=template_2.php"><i class="fa fa-door-open"></i> Akses Ruangan</a>
                      <a class="dropdown-item" href="permit.php?Template=template_2.php" ><i class="fa fa-envelope"></i> Permit</a>
                    </div>
                  </div>
                </li>
                <li class="nav-item">
