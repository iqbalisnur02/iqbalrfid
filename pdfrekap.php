...
$mpdf = new \Mpdf\Mpdf(['margin_top' => 0]);
...
<br>
  <center>
   <p><h2>REKAPITULASI PRESENSI BULANAN</h2></p>
   <strong>Periode: '.$month." ".$thn.'</strong><br><br>
...
$mpdf->Output('Rekapitulasi Presensi '.$month.'.pdf', \Mpdf\Output\Destination::DOWNLOAD);
